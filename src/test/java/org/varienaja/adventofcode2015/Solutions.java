...
public class Solutions {
  ...
  public void testDay2() throws Exception {
    ...
    try (BufferedReader r = new BufferedReader(new InputStreamReader(Solutions.class.getClassLoader().getResourceAsStream("day2.txt")))) {
      int sum = 0;
      String line = null;
  ...
  public void testDay5() throws Exception {
    ...
    try (BufferedReader r = new BufferedReader(new InputStreamReader(Solutions.class.getClassLoader().getResourceAsStream("day5.txt")))) {
      int sum = 0;
      String line = null;
      while ((line = r.readLine()) != null) {
        if (solveDay5a(line)) {
  ...
  public void testDay6() throws Exception {
    ...
    try (BufferedReader r = new BufferedReader(new InputStreamReader(Solutions.class.getClassLoader().getResourceAsStream("day6.txt")))) {
      String line = null;
      while ((line = r.readLine()) != null) {
  ...
  public void testDay7() throws Exception {
    ...
    System.out.println("***");
    List<String> instructions = new LinkedList<>();
    try (BufferedReader r = new BufferedReader(new InputStreamReader(Solutions.class.getClassLoader().getResourceAsStream("day7.txt")))) {
      String line = null;
      while ((line = r.readLine()) != null) {
        instructions.add(line);
      }
  ...
  public void testDay8() throws Exception {
    ...
    try (BufferedReader r = new BufferedReader(new InputStreamReader(Solutions.class.getClassLoader().getResourceAsStream("day8.txt")))) {
      String line = null;
      while ((line = r.readLine()) != null) {
        lines.add(line);
      }
  ...
  public void testDay9() throws Exception {
    ...
    List<String> lines = new LinkedList<>();
    try (BufferedReader r = new BufferedReader(new InputStreamReader(Solutions.class.getClassLoader().getResourceAsStream("day9.txt")))) {
      String line = null;
      while ((line = r.readLine()) != null) {
        lines.add(line);
      }
